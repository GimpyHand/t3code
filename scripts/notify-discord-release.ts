  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new And I Code prerelease is available for nightly testers."
          : "A new And I Code latest release is available.",
...
).pipe(Command.withDescription("Post a And I Code release announcement to Discord."));
