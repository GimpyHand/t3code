...
# Invoked by ssh via SSH_ASKPASS when And I Code re-runs ssh with a cached password
...
printf 'And I Code ssh-askpass invoked without T3_SSH_AUTH_SECRET.\\n' >&2
exit 1
`;
...
const ASKPASS_WINDOWS_SCRIPT = `# Invoked by ssh via SSH_ASKPASS (through ssh-askpass.cmd) when And I Code re-runs\r
...
[Console]::Error.WriteLine("And I Code ssh-askpass invoked without T3_SSH_AUTH_SECRET.")\r
exit 1\r
`;
