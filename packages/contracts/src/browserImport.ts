 ...
 * machine into a And I Code browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** And I Code profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give And I Code Full Disk Access in System Settings → Privacy & Security, then retry.",
