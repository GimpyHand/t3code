...
/**
 * The palette And I Code wears with no theme installed, captured from the app's
...
/**
 * The standard And I Code look as a theme palette, for seeding a new theme when
...
/**
 * The status colors And I Code shows without a theme, read from the app's own
