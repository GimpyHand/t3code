    ...
    widgets: [
      {
        ...
        description: "Subscription quotas from your connected And I Code environments.",
        configuration: {
      ...
      },
      {
        ...
        description: "Shows the current state of active And I Code agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow And I Code to connect to And I Code servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow And I Code to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow And I Code to use your microphone for voice input.",
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow And I Code to access your camera so you can scan pairing QR codes.",
