...
<header>↑ Drag And I Code into the list above</header>
<button id="app" draggable="true" aria-label="Drag And I Code to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">And I Code</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged And I Code icon is missing.");
