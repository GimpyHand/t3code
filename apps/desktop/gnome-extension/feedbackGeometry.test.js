...
it("activates only a window of the process authenticated by D-Bus", () => {
  const target = window(42, "And I Code");
  expect(findCaptureDestination([window(99, "And I Code"), target], 42, "And I Code")).toBe(target);
  expect(findCaptureDestination([window(99, "And I Code")], 42, "And I Code")).toBeUndefined();
